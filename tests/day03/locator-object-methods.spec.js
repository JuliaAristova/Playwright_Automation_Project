...
test.describe("Locator Object Methods", () => {
  ...
  //check() - checks radio buttons and checkboxes only if they are not checked
  ...
  //uncheck() - unchecks radio buttons and checkboxes if they are not unchecked
  ...
  test("SelectOption", async ({ page }) => {
    ...
    //await simpleDropdown.selectOption("1");    //by default - selecting by value
    //await simpleDropdown.selectOption({ label: "Option 1" }); //selecting by label - key and value  
